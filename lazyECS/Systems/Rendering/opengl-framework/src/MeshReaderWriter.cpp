...
void MeshReaderWriter::loadMeshFromFile(const std::string& filename, lazyECS::Mesh& meshToCreate) {
...
void MeshReaderWriter::writeMeshToFile(const std::string& filename, const lazyECS::Mesh& meshToWrite) {
...
void MeshReaderWriter::writeOBJFile(const std::string& filename, const lazyECS::Mesh& meshToWrite) {
